...
class Tweet {
    ...
    get source() {
        ...
        const looksCompleted = t.startsWith("just completed") ||
            t.startsWith("i just ") ||
            t.includes(" completed a ") ||
            t.includes(" completed an ");
        const looksLive = t.startsWith("just posted") || /\bis (running|biking|walking|skiing|swimming)\b/.test(t);
        const looksAchievement = t.includes("new personal record") ||
            t.includes("pr!") ||
            t.includes("achieved") ||
